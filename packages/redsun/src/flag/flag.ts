export namespace Flag {
  ...
  export const REDSUN_EXPERIMENTAL_CONTEXT_FRAGMENT_MAX_CHARS = number("REDSUN_EXPERIMENTAL_CONTEXT_FRAGMENT_MAX_CHARS")
  export const REDSUN_EXPERIMENTAL_VOLATILE_CONTEXT_MAX_CHARS = number("REDSUN_EXPERIMENTAL_VOLATILE_CONTEXT_MAX_CHARS")
  export const REDSUN_EXPERIMENTAL_TOOL_OUTPUT_MAX_CHARS = number("REDSUN_EXPERIMENTAL_TOOL_OUTPUT_MAX_CHARS")
  export const REDSUN_EXPERIMENTAL_TOOL_OUTPUT_PREVIEW_CHARS = number("REDSUN_EXPERIMENTAL_TOOL_OUTPUT_PREVIEW_CHARS")
  export const REDSUN_EXPERIMENTAL_TOOL_RESULT_REPLAY_MAX_CHARS = number("REDSUN_EXPERIMENTAL_TOOL_RESULT_REPLAY_MAX_CHARS")
  export const REDSUN_EXPERIMENTAL_CUSTOM_MESSAGE_MAX_CHARS = number("REDSUN_EXPERIMENTAL_CUSTOM_MESSAGE_MAX_CHARS")
  export const REDSUN_EXPERIMENTAL_SCHEMA_DESCRIPTION_MAX_CHARS = number("REDSUN_EXPERIMENTAL_SCHEMA_DESCRIPTION_MAX_CHARS")
  export const REDSUN_EXPERIMENTAL_ATTACHMENT_MAX_BYTES = number("REDSUN_EXPERIMENTAL_ATTACHMENT_MAX_BYTES")
