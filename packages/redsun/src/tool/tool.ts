...
import { assertProtectedWrite } from "@/extension/protected"
    ...
    Effect.gen(function* () {
      ...
      toolInfo.execute = (args, ctx) => {
        ...
        return Effect.gen(function* () {
          ...
          yield* assertProtectedWrite(id, decoded as Record<string, unknown>, ctx)
          const result = yield* execute(decoded as Schema.Schema.Type<Parameters>, ctx).pipe(
            Effect.tapError((error) =>
              Effect.gen(function* () {
                const instance = yield* InstanceState.context
                yield* Effect.promise(() =>
                  ExtensionRuntime.toolError(instance.directory, {
