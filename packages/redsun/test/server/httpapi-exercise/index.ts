...
const scenarios: Scenario[] = [
  ...
  http.protected
    ...
    .seeded(() =>
      Effect.promise(() =>
        Bun.write(
          path.join(exerciseConfigDirectory, "redsun.jsonc"),
      ...
      (body) =>
        Effect.gen(function* () {
          ...
          const text = yield* Effect.promise(() =>
            Bun.file(path.join(exerciseConfigDirectory, "redsun.jsonc")).text(),
          )
...
const main = Effect.gen(function* () {
  ...
  yield* Effect.promise(() =>
    Bun.write(
      path.join(exerciseConfigDirectory, "redsun.json"),
