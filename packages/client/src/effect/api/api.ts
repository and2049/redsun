...
export type RemotePolicyInput = { readonly enabled: boolean }
export type RemotePolicyOutput = RemoteControl.PolicyResult
export type RemotePolicyOperation<E = never> = (input: RemotePolicyInput) => Effect.Effect<RemotePolicyOutput, E>

export type RemoteEnrollInput = { readonly backendID: string; readonly credentialID: string; readonly digest: string }
export type RemoteEnrollOutput = void
export type RemoteEnrollOperation<E = never> = (input: RemoteEnrollInput) => Effect.Effect<RemoteEnrollOutput, E>

export type RemoteRevokeOutput = RemoteControl.PolicyResult
export type RemoteRevokeOperation<E = never> = () => Effect.Effect<RemoteRevokeOutput, E>

export type RemoteHeartbeatInput = { readonly connected: boolean }
export type RemoteHeartbeatOutput = RemoteControl.Status
export type RemoteHeartbeatOperation<E = never> = (
  input: RemoteHeartbeatInput,
...
export interface RemoteApi<E = never> {
  ...
  readonly revoke: RemoteRevokeOperation<E>
  readonly heartbeat: RemoteHeartbeatOperation<E>
}
...
export type RemoteCatalogAgentsInput = { readonly location?: { readonly directory?: string | undefined } | undefined }
export type RemoteCatalogAgentsOutput = {
  readonly location: Location.PublicRef
  readonly data: ReadonlyArray<RemoteControl.AgentChoice>
}
export type RemoteCatalogAgentsOperation<E = never> = (
  input?: RemoteCatalogAgentsInput,
) => Effect.Effect<RemoteCatalogAgentsOutput, E>

export type RemoteCatalogModelsInput = { readonly location?: { readonly directory?: string | undefined } | undefined }
export type RemoteCatalogModelsOutput = {
  readonly location: Location.PublicRef
  readonly data: ReadonlyArray<RemoteControl.ModelChoice>
}
export type RemoteCatalogModelsOperation<E = never> = (
  input?: RemoteCatalogModelsInput,
...
export type PermissionModeGetOutput = { readonly mode: Permission.Mode }
export type PermissionModeGetOperation<E = never> = () => Effect.Effect<PermissionModeGetOutput, E>

export type PermissionModeSetInput = { readonly mode: Permission.Mode }
export type PermissionModeSetOutput = void
export type PermissionModeSetOperation<E = never> = (
...
export type ConfigContextGetInput = { readonly location?: { readonly directory?: string | undefined } | undefined }
...
export interface AppApi<E = never> {
  ...
  readonly remoteCatalog: RemoteCatalogApi<E>
