...
export const Definitions = {
  "session.pins": keybind("none", "List pinned messages"),
  ...
  "permission.mode": keybind("shift+tab", "Cycle permission mode"),
  ...
  "session.child.list.next": keybind("down", "Select next active subagent"),
  "session.child.list.previous": keybind("up", "Select previous active subagent"),
  "session.parent": keybind("ctrl+up", "Go to parent session"),
  ...
  "session.last": keybind("ctrl+alt+g,end,ctrl+end", "Navigate to last message"),
