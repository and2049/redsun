...
export const Definitions = {
  ...
  session_export: keybind("none", "Export session to editor"),
  session_copy: keybind("none", "Copy session transcript"),
  session_move: keybind("none", "Move session"),
  session_new: keybind("ctrl+n", "Create a new session"),
  session_list: keybind("none", "List all sessions"),
  session_timeline: keybind("ctrl+g", "Show session timeline"),
  ...
  session_compact: keybind("none", "Compact the session"),
  ...
  session_queued_prompts: keybind("ctrl+shift+q", "Manage queued prompts"),
  session_child_first: keybind("down,ctrl+down", "Go to first child session"),
  session_child_cycle: keybind("right", "Go to next child session"),
  session_child_cycle_reverse: keybind("left", "Go to previous child session"),
  session_parent: keybind("up", "Go to parent session"),
  session_pin_toggle: keybind("ctrl+f", "Pin or unpin session in the session list"),
  session_quick_switch_1: keybind("alt+1", "Switch to session in quick slot 1"),
  session_quick_switch_2: keybind("alt+2", "Switch to session in quick slot 2"),
  session_quick_switch_3: keybind("alt+3", "Switch to session in quick slot 3"),
  session_quick_switch_4: keybind("alt+4", "Switch to session in quick slot 4"),
  session_quick_switch_5: keybind("alt+5", "Switch to session in quick slot 5"),
  session_quick_switch_6: keybind("alt+6", "Switch to session in quick slot 6"),
  session_quick_switch_7: keybind("alt+7", "Switch to session in quick slot 7"),
  session_quick_switch_8: keybind("alt+8", "Switch to session in quick slot 8"),
  session_quick_switch_9: keybind("alt+9", "Switch to session in quick slot 9"),
  ...
  worker_model: keybind("none", "Select worker model"),
  ...
  messages_copy: keybind("none", "Copy message"),
  messages_undo: keybind("none", "Undo message"),
  messages_redo: keybind("none", "Redo message"),
  messages_toggle_conceal: keybind("none", "Toggle code block concealment in messages"),
