...
export const Definitions = {
  ...
  app_exit: keybind("ctrl+q", "Exit the application"),
  ...
  session_child_first: keybind("ctrl+down", "Go to first child session"),
  session_child_list_next: keybind("down", "Select next active subagent"),
  session_child_list_previous: keybind("up", "Select previous active subagent"),
  session_parent: keybind("ctrl+up", "Go to parent session"),
...
export const CommandMap = {
  ...
  session_child_list_next: "session.child.list.next",
  session_child_list_previous: "session.child.list.previous",
