...
test("mode-less bindings stay active when opencode mode changes", async () => {
  ...
  try {
    expect(counts).toEqual({
      base: { "session.list": 0, "session.new": 1, "session.page.up": 2, "session.first": 2, "model.list": 0 },
      question: { "session.list": 0, "session.new": 1, "session.page.up": 2, "session.first": 2, "model.list": 0 },
      autocomplete: {
        "session.list": 0,
        "session.new": 1,
        "session.page.up": 2,
