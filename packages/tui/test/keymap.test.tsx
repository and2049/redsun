...
test("mode-less bindings stay active when opencode mode changes", async () => {
  ...
  try {
    expect(counts).toEqual({
      base: { "session.list": 1, "session.new": 2, "session.page.up": 2, "session.first": 2, "model.list": 1 },
      question: { "session.list": 1, "session.new": 2, "session.page.up": 2, "session.first": 2, "model.list": 0 },
      autocomplete: {
        "session.list": 1,
        "session.new": 2,
        "session.page.up": 2,
