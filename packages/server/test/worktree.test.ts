  ...
  () =>
    Effect.gen(function* () {
      ...
      yield* Effect.promise(async () => {
        ...
        await Bun.write(path.join(config, "redsun.json"), JSON.stringify({ worktree: { directory: destination } }))
      })
