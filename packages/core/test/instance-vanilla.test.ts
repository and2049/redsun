        ...
        Effect.gen(function* () {
          ...
          const plant = (name: string) =>
            Effect.promise(async () => {
              ...
              await fs.writeFile(path.join(directory, "redsun.json"), "{}")
      ...
      Effect.flatMap((dir) =>
        Effect.gen(function* () {
          ...
          yield* Effect.promise(async () => {
            await fs.mkdir(path.join(directory, ".redsun", "plugins"), { recursive: true })
            await fs.writeFile(
              path.join(directory, ".redsun", "plugins", "ambient.ts"),
              [
