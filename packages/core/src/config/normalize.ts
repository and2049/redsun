...
function normalizeCompaction(
  ...
  unsupportedIfPresent(input.compaction, "keep_recent", ["compaction", "keep_recent"], diagnostics)
  unsupportedIfPresent(input.compaction, "keepRecent", ["compaction", "keepRecent"], diagnostics)
