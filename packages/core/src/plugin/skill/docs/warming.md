...
[redsun configuration file](config.md):
...
With the defaults, redsun sends a warming request after a session has made no
...
requests. redsun logs warming failures without failing or changing the
