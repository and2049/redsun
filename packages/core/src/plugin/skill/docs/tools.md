...
Ask for the outcome you want. redsun chooses the available tools, requests
...
Use `edit` for a focused change. redsun may format the file after writing it.
...
redsun exposes `patch` for supported GPT models; other models receive `edit`
