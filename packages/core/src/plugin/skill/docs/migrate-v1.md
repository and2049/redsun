...
OpenCode V1 and redsun both use the `opencode` command and are no longer installed side by side by default. Remove a
...
Use the `@opencode/client` package to access the released V2 API. See the generated [API reference](https://opencode.ai/v2/docs/api) for its
