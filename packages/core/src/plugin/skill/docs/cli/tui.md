...
Run redsun from your project, type a request, and press **Enter**.
...
Press **Shift+Enter**, **Ctrl+Enter**, or **Ctrl+J** for a new line. While redsun is working, **Enter** steers the active session and **Alt+Enter** queues the prompt for later.
