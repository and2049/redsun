...
The `app.clear` command works only in [`redsun mini`](index.md). Press `ctrl+l` to clear the visible screen and draw the prompt again. The terminal keeps the scrollback.
