...
redsun includes built-in light and dark themes. Choose a color scheme in settings, or use colors derived from your terminal.
...
Choose whether redsun follows your terminal's appearance or always uses light or dark colors:
...
When redsun can read your terminal palette, the theme picker also includes `system`. This theme derives its colors from your terminal's foreground, background, and ANSI palette.
