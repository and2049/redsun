...
export class OpenCodeDO {
  ...
  constructor(state: DurableObjectState) {
    this.redsun = state.blockConcurrencyWhile(() =>
...
Wrangler selects redsun's Workerd-safe implementations through the `workerd` package condition. Cloudflare may evict
...
Customize your redsun instance by registering plugins bundled with your
